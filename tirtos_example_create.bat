E:\uC-Soft\TI\TIRTOS\pdk_am335x_1_0_9\packages\pdkProjectCreate.bat AM335x bbbAM335x little all example arm E:\uC-Soft\TI\TIRTOS\pdk_am335x_1_0_9\packages
...
set module_list=all aif2 bcp cppi csl dfe emac fatfs fm fftc gpio gpmc hyplnk i2c icss_emac iqn2 mcasp mcbsp mmap mmcsd nimu nimu_icss nwal osal pa pcie pktlib pruss qm rm sa serdes_diag spi srio tcp3d tfw transportqmss transportsrio tsip uart usb wdtimer vps dcan
...
set IPC_VERSION=3.47.00.00

REM EDMA3 Version
set EDMA_VERSION=2.12.05.30B

REM Version of the PDK
set PDK_VERSION=1.0.9
